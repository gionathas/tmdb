export const Properties = {
  ...
  LOGO_PATH: "/logo.svg",
  EMPTY_POSTER_IMG_SRC: "/img/empty.jpeg",
  ...
  DEFAULT_MAX_SLIDESHOW_ITEMS_NUMBER: 20,
  DEFAULT_MAX_CAROUSEL_ITEMS_NUMBER: 20,
  DEFAULT_MAX_LIST_ITEMS_NUMBER: 20,
  DEFAULT_MAX_GENRES_TO_SHOW: 2,
};
